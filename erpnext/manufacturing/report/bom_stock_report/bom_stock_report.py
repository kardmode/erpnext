...
def execute(filters=None):
	...
	for item in items:
		base_qty = item.required_qty/bom_quantity
		...
		data.append([item.item_code,item.description,required_qty,item.required_uom,stock_qty,item.stock_uom,item.actual_qty,can_build])
...
def get_columns():
    ...
    columns = [
        ...
        _("Required Stock Qty") + ":Float:100",
