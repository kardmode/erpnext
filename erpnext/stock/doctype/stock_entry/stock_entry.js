...
frappe.ui.form.on('Stock Entry', {
	...
	calculate_basic_amount: function(frm, item) {
		...
		frm.events.calculate_balance_qty(item);
	...
	calculate_amount: function(frm) {
		...
		frm.doc.total_incoming_qty = total_incoming_qty;
		frm.doc.total_outgoing_qty = total_outgoing_qty;
		frm.doc.total_qty_difference = total_incoming_qty - total_outgoing_qty;
