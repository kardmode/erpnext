...
class StockEntry(StockController):
	...
	def validate_finished_goods(self):
		...
		for d in self.get('items'):
			...
			if self.work_order and self.purpose == "Manufacture" and d.t_warehouse and not d.s_warehouse:
				items_with_target_warehouse.append(d.item_code)
			elif not self.work_order and self.purpose == "Manufacture" and d.t_warehouse and not d.s_warehouse:
				items_with_target_warehouse.append(d.item_code)
