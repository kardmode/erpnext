...
frappe.require("assets/frappe/js/lib/jstree/jstree.min.js");
frappe.require("assets/frappe/js/lib/jstree/themes/default/style.css");
...
frappe.ui.form.on('Project Breakdown', {
	...
	refresh: function(frm) {
		...
		cur_frm.add_custom_button(__("Get Details"), function() {
			...
			frm.web_link && frm.web_link.remove();		frm.add_custom_button(__('Download Summary'), function() {
				var w = window.open(
...
get_details2 = function(){
	var doc = cur_frm.doc;
	frappe.call({
		method:'erpnext.projects.doctype.project_breakdown.project_breakdown.get_details2',
		args:{
			project: doc.project
		},
		callback: function(r) {
